...
class Orders extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        //只允许有一条未支付的订单的话  先查询带uid status:0条件查询
        Db::startTrans();
        ...
        if ($existGoods) {
            //还有商品存在则更新
            $cartRes = $cartModel->updateCart(['id' => $uid], ['total' => 0, 'price' => 0]);
        } else {
    ...
    public function read($id)
    {
        ...
        try {
            ...
            $ordersGoods = Db::table('goods')->field('id,gname,gthumb,nprice')->where('id', 'in', $gid)->select();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $ordersModel = model('Ordersmodel');
            $res = $ordersModel->updateOrders(['uid' => $uid, 'ordernum' => $id], $data);
            if ($res) {
                return json([
                    'code' => config('code.success'),
                    'msg' => '订单修改成功',
